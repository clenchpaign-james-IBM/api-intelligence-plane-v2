"""
Migration 014: WebMethods Metrics 1d Index Template

Creates the 1-day metrics index template. Intended retention is 90 days.
"""

from opensearchpy import OpenSearch


INDEX_TEMPLATE_NAME = "metrics-1d-template"
INDEX_PATTERN = "metrics-1d-*"


def create_metrics_1d_index_template(client: OpenSearch) -> None:
    """Create the 1-day metrics index template."""
    ...
    template_body = {
        ...
        "_meta": {
            "description": "1-day aggregated metrics for WebMethods analytics",
            "retention": "90d",
        },
    }
